    ...
    return (
      <NavigationBar {...this.props}>
        <View style={styles.card}>
          <Text style={styles.title}>Introduction to nature in Hwa Chong</Text>
          <Text style={styles.subtext}>海天辽阔 云树苍龙 中有我华中</Text>
          <Text>{"\n"}</Text>
          ...
          <Text style={[styles.description, {textAlign: 'justify'}]}>The flora in our school is also a reflection of the school’s emphasis its Chinese values. Many of the school’s trees and plants were donated by the school alumni over the past few decades - a strong testimony of the value of 饮水思源.</Text>
          <Text style={[styles.description, {textAlign: 'justify'}]}>It is only with the devotion and dedication of countless generations of Hwa Chong staff and students that we are able to experience the exquisite garden campus today.</Text>

          <Text style={[styles.description, {textAlign: 'justify'}]}>Hence, this year, on Hwa Chong’s 100th anniversary, we are pleased to document and share the rich biodiversity of the school with everyone else. We have presented a specially curated list of flora and fauna, accompanied by a beautiful compendium of photos in an easy-to-access application and a convenient website, to accentuate the beauty of the school. We hope that you will spare some time and allow yourself to be enthralled by the beauty of our school, our second home. </Text>
        </View>
      </NavigationBar>
    );
  }
